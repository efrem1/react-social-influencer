...
import { Twitter, Delete } from "@mui/icons-material";
...
export class TwitterForm extends React.Component {
  ...
  onSubmitHashtag = (event) => {
    ...
    if (hashtagRegex.test(hashtag)) {
      const temp = twitter.hashtags;
      temp.push(hashtag);
      dispatch({
        type: "twitter",
        payload: { ...twitter, hashtags: temp },
      });
  ...
  onSubmitHandle = (event) => {
    ...
    if (handleRegex.test(handle)) {
      const temp = twitter.mentions;
      temp.push(handle);
      dispatch({
        type: "twitter",
        payload: { ...twitter, mentions: temp },
      });
  ...
  onSubmitUrl = (event) => {
    ...
    if (urlRegex.test(url)) {
      const temp = twitter.urls;
      temp.push(url);
      dispatch({
        type: "twitter",
        payload: { ...twitter, urls: temp },
      });
      this.setState({ url: "" });
    }
  }
