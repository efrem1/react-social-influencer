...
export default function BrandLayout({ children, drawer = false }) {
        ...
        >
          ...
          <Box sx={{ overflow: "auto" }}>
            <ListItemButton component="div" selected>
              <ListItemText
                primary={t(`BrandDashboard.${campaign.title}`).toUpperCase()}
              />
            </ListItemButton>
            {campaign.links.map((item) => {
              ...
              return (
                <ListItemButton
                  ...
                  onClick={() => handleNavigate(`/campaign?status=${item}`)}
                >
                  <ListItemText
